...
The cleaned accelerametor dataset contains `r nrow(accel_data)` observations and `r ncol(accel_data)` variables. 
...
```{r fig.asp = .7, out.width = "70%", dpi = 300, fig.align = "center"}
accel_data %>% 
  group_by(day) %>% 
