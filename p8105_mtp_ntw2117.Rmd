...
density_full <- accel_data %>% 
  ...
  ggplot(aes(x = log_actvty_count, color = weeks)) +
...
wrap_elements(density_full / (density_zoom_1 + density_zoom_2)) + ggtitle("Title")

# maybe split up these density plots so they are zoomed in on different ranges of valueswee
# explore the use of the geometric mean
```
